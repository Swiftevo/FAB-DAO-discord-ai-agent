...
自 2026-06-23 起，每日更新日記改為獨立檔案，存放於 `development_logs/YYYY-MM-DD.md`。

本文件保留作為總索引與早期歷史記錄。後續每天的詳細紀錄應寫入當日獨立檔案，避免單一長檔案在壓縮、摘要或回溯時遺漏重要細節。

- 2026-06-23：`development_logs/2026-06-23.md`
...
## 2026-06-22 Ghost Object 補助金專案

### 新增資料

- 建立 `APP_006`：Round 5 累鼠「Ghost Object 不可能物件_2026 展覽計畫」。
- 保存維護者提供的完整企劃文字、原企劃書連結及 Discord 討論頻道。
- 記錄 FAB DAO 專案聯絡人 FL YANG 與公開 Discord ID。
- 結構化整理策展團隊、展覽目標、台日交流、教育連結、焦點討論、時程、預算及預期成果。
- 將行動客廳 Grant 與藝術銀行合作 / 購藏標記為兩種不同資金關係。

### 核准與撥款更新

- 維護者確認本案已正式核准為累鼠 1,600 USDT。
- 記錄 960 USDT（60%）啟動資金、Optimism 收款錢包及行動客廳 Safe 交易來源。
- 補充申請者實踐老師_Alvis 與公開 Discord ID。
- 原企劃預算表的 97,500 NTD / 3,100 USD 作為歷史提案資料保留，不視為額外核定。
- 藝術銀行焦點聚會補助及作品購藏尚未核定，與已核准 Grant 分開記錄。
- Safe 網頁受 Cloudflare 限制，工具無法獨立讀取交易細節；目前交易狀態標示為維護者確認。

## 2026-06-23 事水補助金專案更新
...
- 更新 `APP_004` 結構化 record、總 summary、行動客廳 sources 與 TODO。
